...
\begin{figure*}[t]
    ...
    \caption{Overview of DINO-SPR. A frozen DINOv3 backbone is adapted to surgical video through a
    Salient Spatial Token Selection (SSTS) module and a Keyframe-Prior Temporal Fusion (KPTF)
    module. DINO-SPR Lite further compresses the adapted model into lightweight backbones of
