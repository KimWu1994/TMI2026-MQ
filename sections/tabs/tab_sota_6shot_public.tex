...
SPR-Teacher (DINOv3 ViT-B) & End-to-end &  & \textbf{80.1$\pm$0.2} & \textbf{72.7$\pm$0.1} & \textbf{76.6$\pm$0.8} & \textbf{70.7$\pm$0.5} & \textbf{58.1$\pm$0.4} &  & \textbf{85.2$\pm$0.1} & \textbf{83.4$\pm$0.1} & \textbf{82.7$\pm$0.1} & \textbf{79.5$\pm$0.2} & \textbf{71.0$\pm$0.2} \\
\midrule
...
SPR-Teacher (DINOv3 ViT-B) & End-to-end &  & \textbf{72.3$\pm$0.8} & \textbf{64.9$\pm$1.1} & \textbf{71.5$\pm$0.5} & \textbf{62.9$\pm$0.2} & \textbf{50.6$\pm$0.3} &  & \textbf{67.9$\pm$1.1} & \textbf{59.1$\pm$1.0} & \textbf{53.8$\pm$0.6} & \textbf{52.9$\pm$0.3} & \textbf{41.3$\pm$0.3} \\
\bottomrule
\end{tabular}
