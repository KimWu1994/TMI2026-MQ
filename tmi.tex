...
% OphCLIP++: Foundation Model-Based Few-Shot Adaptation for Online Ophthalmic Surgery Phase Recognition
% OphCLIP+: Adapting Foundation Model to Real-world Scenarios for Ophthalmic Surgery
...
\input{sections/5_conclusion_limitation}
